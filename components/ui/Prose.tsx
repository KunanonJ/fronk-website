  ...
  return (
    <div
      className={cn(
        ...
        "prose-code:rounded-none prose-code:border prose-code:border-border prose-code:bg-surface-2 prose-code:px-1 prose-code:py-0.5 prose-code:text-[0.875em] prose-code:before:content-[''] prose-code:after:content-['']",
        "prose-pre:rounded-none prose-pre:border prose-pre:border-border prose-pre:bg-surface-2",
