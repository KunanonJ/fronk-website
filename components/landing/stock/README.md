# Landing design stock

Unmapped hero / page experiments. Preview locally; do **not** add to nav or
`app/sitemap.ts` until a cutover is planned.
...
| `/blog` | `../BlogIndex.tsx` | Sanity posts + search/tag filter; CMS via Studio **Blog → Posts** |
