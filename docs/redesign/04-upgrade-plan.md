...
| **D4** | Instrument (mono) font | Geist Mono (free, loaded) · Space/IBM Plex/JetBrains (free) · Cartograph (PAID — excluded) | Default **Geist Mono** (zero-cost); revisit for more character later. |
